...
$(document).ready(function(){
  ...
  .done(function(res){
    // console.log(res);
    // ** MAP RESULTS FROM GET REQUEST
    // * AND SAVE IT TO THE VAR NEIGHBORHOOD_NAMES
    // SAVE EACH ENTRY IN AN ARRY
    // AND SAVE THE NAME AND ID FOR EACH ENTRY
